...
@section('title') byPrice @endsection
@section('css')

@endsection
@section('content')
    @component('components.breadcrumb')
        @slot('li_1') Price By Count @endslot
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @if($row->seat_type_id == 1)
                                            <span class="badge badge-pill badge-soft-success font-size-12">Business</span>
                                        @else
                                            <span class="badge badge-pill badge-soft-warning font-size-12">Economy</span>
                                        @endif    
                                    </td>
                                    <td>
